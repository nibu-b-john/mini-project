...
class NotiLeaveWidget extends StatefulWidget {
  final double long;
  final double lat;
  final String status;
  // final String day;
  ...
  @override
  State<NotiLeaveWidget> createState() => _NotiLeaveWidgetState();
}

class _NotiLeaveWidgetState extends State<NotiLeaveWidget> {
